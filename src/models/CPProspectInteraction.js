...
const cpProspectInteractionSchema = new mongoose.Schema({
  ...
  action: { type: String, enum: ["call_started", "verification_result", "broker_call_result", "profile_updated", "whatsapp_number_updated", "whatsapp_opened", "whatsapp_result", "note"], required: true, index: true },
