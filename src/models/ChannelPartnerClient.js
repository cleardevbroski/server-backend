...
const channelPartnerClientSchema = new mongoose.Schema({
  ...
  requirementType: { type: String, enum: ["specific_project", "general_requirement"], default: "specific_project", index: true },
  projectId: { type: mongoose.Schema.Types.ObjectId, ref: "Property", default: null, index: true },
  projectTitle: { type: String, default: "", trim: true, maxlength: 180 },
  preferredLocation: { type: String, default: "", trim: true, maxlength: 180 },
