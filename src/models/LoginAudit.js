...
const loginAuditSchema = new mongoose.Schema(
  {
    ...
    role: { type: String, enum: ["user", "admin", "guest", ""], default: "" },
    method: { type: String, enum: ["otp_requested", "otp", "manual", "password", "password_registration", "truecaller"], required: true },
